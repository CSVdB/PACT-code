...
(function($PS) {
  ...
  var $dollar_GenericRoute__5 = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Router (line 11, column 1 - line 11, column 32): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var routeCodec = Routing_Duplex.root(Routing_Duplex_Generic.sum($dollar_GenericRoute__5)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
      return "Home";
  ...
  var $dollar_EqRoute_6 = new Data_Eq.Eq(function (x) {
      return function (y) {
  ...
  exports["$_EqRoute_6"] = $dollar_EqRoute_6;
})(PS);
(function($PS) {
  // Generated by purs version 0.14.2
  "use strict";
...
(function($PS) {
  ...
  var render = function (v) {
      if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Router.Home) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Hello, world!") ]);
      };
      if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Router.Login) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Welcome to the login page!") ]);
      };
      if (v.route instanceof Data_Maybe.Just && v.route.value0 instanceof Router.Register) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Welcome to the register page!") ]);
      };
      ...
      throw new Error("Failed pattern match at Main (line 92, column 1 - line 92, column 72): " + [ v.constructor.name ]);
  };
  var initialState = Data_Function["const"]({
      route: new Data_Maybe.Just(Router.Home.value)
  });
  var $$eval = (function () {
      var receive = Data_Function["const"](Data_Maybe.Nothing.value);
      var initialize = new Data_Maybe.Just(Initialize.value);
      var handleQuery = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Router["$_EqRoute_6"]))(v1.route)(new Data_Maybe.Just(v.value0)))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $16 = {};
                  for (var $17 in v2) {
      ...
      var handleAction = function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)((function () {
              var $23 = Routing_Duplex.parse(Router.routeCodec);
              return function ($24) {
                  return Data_Either.hush($23($24));
              };
          })())(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Routing_Hash.getHash)))(function (initialRoute) {
              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Routing_Hash.setHash(Routing_Duplex.print(Router.routeCodec)(Data_Maybe.fromMaybe(Router.Home.value)(initialRoute))));
          });
      };
  ...
  var rootComponent = Halogen_Component.mkComponent({
      initialState: initialState,
      render: render,
      "eval": $$eval
  });
  var main = function __do() {
      Effect_Console.log("And we're launching!")();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (htmlBody) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(rootComponent)(Router.Home.value)(htmlBody))(function (halogenIO) {
              return Data_Functor["void"](Effect_Aff.functorAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.matchesWith(Data_Foldable.foldableEither)(Routing_Duplex.parse(Router.routeCodec))(function (old) {
                  return function ($$new) {
                      return Control_Applicative.when(Effect.applicativeEffect)(Data_Eq.notEq(Data_Maybe.eqMaybe(Router["$_EqRoute_6"]))(old)(new Data_Maybe.Just($$new)))(Effect_Aff.launchAff_(halogenIO.query(Halogen_Query.mkTell(Navigate.create($$new)))));
                  };
              })));
          });
      }))();
